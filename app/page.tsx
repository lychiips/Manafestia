    ...
    <div className="min-h-screen flex justify-center items-center text-white font-sans"
      ...
      <div className="text-center p-8 rounded-[20px] max-w-[500px] w-[90%]"
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-center gap-4">
            <button
              ...
              className={`px-6 py-3 border-2 border-[#e94560] rounded-[10px] text-white cursor-pointer transition-all duration-300 ${
                currentLang === "en" ? "bg-[#e94560]" : "bg-transparent hover:bg-[rgba(233,69,96,0.2)]"
              }`}
            >
            ...
            <button
              ...
              className={`px-6 py-3 border-2 border-[#e94560] rounded-[10px] text-white cursor-pointer transition-all duration-300 ${
                currentLang === "jp" ? "bg-[#e94560]" : "bg-transparent hover:bg-[rgba(233,69,96,0.2)]"
              }`}
            >
        ...
        <button
          ...
          onMouseEnter={(e) => e.currentTarget.style.boxShadow = "0 6px 20px rgba(233, 69, 96, 0.6)"}
          onMouseLeave={(e) => e.currentTarget.style.boxShadow = "0 4px 15px rgba(233, 69, 96, 0.4)"}
        >
